...
public class DriveToClosestCage extends DriveToCage {   
    public DriveToClosestCage(Drive drive, FieldInfo field, Supplier<Pose2d> robotPose) {
        super(
            drive,
            field,
            robotPose,
            ProximityUtil.getClosestCage(drive, field));
    }

    /** Initializes the robot pose to the global pose of the robot. */
    public DriveToClosestCage(Drive drive, FieldInfo field) {
        this(
            drive,
            field,
