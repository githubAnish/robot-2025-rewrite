...
public class DriveToClosestStation extends DriveToStation {   
    public DriveToClosestStation(Drive drive, FieldInfo field, JoystickInputs inputs, Supplier<Pose2d> robotPose) {
        super(
            drive,
            field,
            inputs,
    ...
    public DriveToClosestStation(Drive drive, FieldInfo field, JoystickInputs inputs) {
        this(
            drive,
            field,
            inputs,
