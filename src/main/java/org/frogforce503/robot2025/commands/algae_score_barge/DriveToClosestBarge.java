...
public class DriveToClosestBarge extends DriveToBarge {   
    public DriveToClosestBarge(Drive drive, FieldInfo field, JoystickInputs inputs, Supplier<Pose2d> robotPose) {
        super(
            drive,
            field,
            inputs,
    ...
    public DriveToClosestBarge(Drive drive, FieldInfo field, JoystickInputs inputs) {
        this(
            drive,
            field,
            inputs,
