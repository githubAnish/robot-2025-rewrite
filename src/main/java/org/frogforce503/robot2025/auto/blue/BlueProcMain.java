...
// public class BlueProcMain extends AutoMode {
...
//         E_TO_HP = routine.trajectory( "Blue-Proc-E_To_HP");
//         scoBlue = routine.trajectory( "Blue-Proc-Score_D");
//         D_TO_HP = routine.trajectory( "Blue-Proc-D_To_HP");
//         scoreC = routine.trajectory( "Blue-Proc-Score_C");
//         C_TO_HP = routine.trajectory( "Blue-Proc-C_To_HP");
//         scoreB = routine.trajectory( "Blue-Proc-Score_B");
