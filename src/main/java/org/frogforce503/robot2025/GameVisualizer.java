...
public class GameVisualizer {
    ...
    public void reset() {
        ...
        addAlgae(
            new AlgaeInfo(field.getConfig().Blue_Algae_AB, SimHeights.kAlgaeL3, 180.0),
            new AlgaeInfo(field.getConfig().Blue_Algae_CD, SimHeights.kAlgaeL2, 230.0),
            new AlgaeInfo(field.getConfig().Blue_Algae_EF, SimHeights.kAlgaeL3, 290.0),
            new AlgaeInfo(field.getConfig().Blue_Algae_GH, SimHeights.kAlgaeL2, 0.0),
            new AlgaeInfo(field.getConfig().Blue_Algae_IJ, SimHeights.kAlgaeL3, 70.0),
            new AlgaeInfo(field.getConfig().Blue_Algae_KL, SimHeights.kAlgaeL2, 130.0));

        addFloorAlgae(
            field.getConfig().BlueLeftAlgae,
            field.getConfig().BlueCenterAlgae,
            field.getConfig().BlueRightAlgae);
