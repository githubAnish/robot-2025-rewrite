...
public class Util {
    ...
    public static double powerCopySign(double x, double power) {
        return Math.copySign(Math.pow(x, power), x);
    }
    ...
    /**
     * Cleans ChassisSpeeds such that those that are obviously too slow will be ignored
     * 
     * @param speeds ChassisSpeeds object to be cleaned
     */
    private ChassisSpeeds cleanseChassisSpeeds(ChassisSpeeds speeds) {
    ...
    /**
     * Corrects for drift while spinning.
     ...
     * @param speeds input ChassisSpeeds
     * @return updated ChassisSpeeds
     */
    private ChassisSpeeds correctDrift(ChassisSpeeds speeds, double dt) {
