...
import org.frogforce503.robot.commands.ClimbingCommands;
import org.frogforce503.robot.commands.EjectCoralOnReefAndStow;
import org.frogforce503.robot.commands.IntakeAlgaeFromGround;
import org.frogforce503.robot.commands.IntakeAlgaeFromHandoff;
import org.frogforce503.robot.commands.IntakeAlgaeFromReef;
import org.frogforce503.robot.commands.SafelyStowAndIntakeCoralFromStation;
import org.frogforce503.robot.commands.ScoreAlgaeInBarge;
import org.frogforce503.robot.commands.ScoreAlgaeInProcessor;
import org.frogforce503.robot.commands.ScoreCoralOnReef;
import org.frogforce503.robot.commands.drive.TeleopDriveCommand;
import org.frogforce503.robot.subsystems.climber.Climber;
import org.frogforce503.robot.subsystems.climber.ClimberIO;
import org.frogforce503.robot.subsystems.climber.ClimberIOSim;
import org.frogforce503.robot.subsystems.climber.ClimberIOSpark;
...
import org.frogforce503.robot.subsystems.offsets.OffsetManager;
import org.frogforce503.robot.subsystems.offsets.OffsetsIO;
import org.frogforce503.robot.subsystems.offsets.OffsetsIOServer;
...
import org.frogforce503.robot.subsystems.superstructure.arm.ArmIO;
import org.frogforce503.robot.subsystems.superstructure.arm.ArmIOSim;
import org.frogforce503.robot.subsystems.superstructure.arm.ArmIOSpark;
import org.frogforce503.robot.subsystems.superstructure.claw.Claw;
import org.frogforce503.robot.subsystems.superstructure.claw.ClawIO;
import org.frogforce503.robot.subsystems.superstructure.claw.ClawIOSim;
import org.frogforce503.robot.subsystems.superstructure.claw.ClawIOSpark;
import org.frogforce503.robot.subsystems.superstructure.elevator.Elevator;
import org.frogforce503.robot.subsystems.superstructure.elevator.ElevatorIO;
import org.frogforce503.robot.subsystems.superstructure.elevator.ElevatorIOSim;
import org.frogforce503.robot.subsystems.superstructure.elevator.ElevatorIOSpark;
import org.frogforce503.robot.subsystems.superstructure.intakepivot.IntakePivot;
import org.frogforce503.robot.subsystems.superstructure.intakepivot.IntakePivotIO;
import org.frogforce503.robot.subsystems.superstructure.intakepivot.IntakePivotIOSim;
import org.frogforce503.robot.subsystems.superstructure.intakepivot.IntakePivotIOSpark;
import org.frogforce503.robot.subsystems.superstructure.intakeroller.IntakeRoller;
import org.frogforce503.robot.subsystems.superstructure.intakeroller.IntakeRollerIO;
import org.frogforce503.robot.subsystems.superstructure.intakeroller.IntakeRollerIOSim;
import org.frogforce503.robot.subsystems.superstructure.intakeroller.IntakeRollerIOSpark;
import org.frogforce503.robot.subsystems.superstructure.sensors.CoralSensorIO;
import org.frogforce503.robot.subsystems.superstructure.sensors.CoralSensorIOBeamBreak;
import org.frogforce503.robot.subsystems.superstructure.wrist.Wrist;
import org.frogforce503.robot.subsystems.superstructure.wrist.WristIO;
import org.frogforce503.robot.subsystems.superstructure.wrist.WristIOSim;
import org.frogforce503.robot.subsystems.superstructure.wrist.WristIOSpark;
...
public class RobotContainer {
    ...
    private void configureButtonBindings() {
        driver.leftTrigger().whileTrue(
            new FFSelectCommand<>(
                Map.of(
                    SuperstructureMode.CORAL_INTAKE, new SafelyStowAndIntakeCoralFromStation(drive, vision, superstructure),
                    SuperstructureMode.ALGAE_GROUND, new IntakeAlgaeFromGround(),
                    SuperstructureMode.ALGAE_HANDOFF, new IntakeAlgaeFromHandoff(),
                    SuperstructureMode.ALGAE_PLUCK, new IntakeAlgaeFromReef(drive, vision, superstructure)
                ),
    ...
    private void configureTriggers() {
        ...
        Trigger gotPiece = new Trigger(() -> superstructure.isHasCoral() || superstructure.isHasAlgaeInClaw() || superstructure.isHasAlgaeInIntake());
